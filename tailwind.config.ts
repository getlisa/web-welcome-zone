...
export default {
	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				'gradient-primary': 'linear-gradient(90deg, #B682E9, #B682E9)',
				'gradient-luxury': 'linear-gradient(90deg, #B682E9, #B682E9, #B682E9)',
				'gradient-dark': 'radial-gradient(circle at 50% 50%, #B682E9, #B682E9)',
